...
The names of Chinese provinces may vary between institutions and data sources: Inner Mongolia might come as "Inner Mongol", "Inner Mongolia Autonomous Region", "内蒙古", "内蒙古自治区", "Nei Menggu" or "Nei Menggu Zizhiqu", making it hard to merge province-level data. 
...
It does not, however, take care of spelling errors that are common in Chinese administrative data. Usually the name in Chinese characters is the least error-prone. 
